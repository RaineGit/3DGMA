...
public class WireMesh_Gizmo : MonoBehaviour {


	[Tooltip ("Color of your Gizmo WireMesh")]
	public Color color = new Color(0.2f, 0.3f, 1f, 1f);

	[Tooltip ("WireMesh for Gizmo")]
	...
	void OnDrawGizmos() { //Always visible
		...
		if (alwaysVisible) {
			...
			Gizmos.DrawWireMesh (object_Mesh, transform.position, Quaternion.identity, Vector3.one);
		}
